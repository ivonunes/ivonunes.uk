...
document.onreadystatechange = async function () {
    if (document.readyState === "complete") {
        ...
        const subscribeIntro = document.createElementNS(NS, "p");
        subscribeIntro.textContent = "Alternatively, you can subscribe to receive new posts by email.";
        body.appendChild(subscribeIntro);

        const subscribeForm = document.createElementNS(NS, "form");
        subscribeForm.setAttribute("method", "POST");
        subscribeForm.setAttribute("action", "https://micro.blog/users/subscribe/198724");
        subscribeForm.setAttribute("style", "margin-top:1rem;");

        const emailInput = document.createElementNS(NS, "input");
        emailInput.setAttribute("type", "email");
        emailInput.setAttribute("name", "email");
        emailInput.setAttribute("size", "30");
        emailInput.setAttribute("placeholder", "Your email address");
        emailInput.setAttribute("required", "");
        emailInput.setAttribute("style", "box-sizing:border-box;display:block;margin:0 0 0.75rem 0;width:100%;");
        subscribeForm.appendChild(emailInput);

        const subscribeButton = document.createElementNS(NS, "input");
        ...
        body.appendChild(subscribeForm);
